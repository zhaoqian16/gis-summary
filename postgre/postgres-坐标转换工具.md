...
- 执行`FreeGIS_Coordinate_Transform.sql`
...
```sql
--火星坐标——wgs1984
select FreeGIS_Coordinate_Transform('public','tablename','GCJ2WGS');
--火星坐标——百度坐标
select FreeGIS_Coordinate_Transform('public','tablename','GCJ2BD');
--wgs1984——火星坐标
select FreeGIS_Coordinate_Transform('public','tablename','WGS2GCJ');
--wgs1984——百度坐标
select FreeGIS_Coordinate_Transform('public','tablename','WGS2BD');
--百度坐标——火星坐标
select FreeGIS_Coordinate_Transform('public','tablename','BD2GCJ');
--百度坐标——wgs1984
select FreeGIS_Coordinate_Transform('public','tablename','BD2WGS');

--注：wgs1984坐标系与cgcs2000差距很小，如果给的数据是cgcs2000，可以直接在arcgis或qgis中转换为wgs1984坐标系。
